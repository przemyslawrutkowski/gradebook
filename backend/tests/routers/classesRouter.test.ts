...
suite('classesRouter', () => {
    ...
    test('updateClass() - success', async () => {
        ...
        assert.strictEqual(updateClassResponse.statusCode, 200, 'Expected the status code to be 200 for the successful class update');
    ...
    test('updateClass() - validation error', async () => {
        ...
        assert.strictEqual(updateClassResponse.statusCode, 400, 'Expected the status code to be 400 for the validation error');
    ...
    test('updateClass() - class does not exist', async () => {
        ...
        assert.strictEqual(updateClassResponse.statusCode, 404, 'Expected the status code to be 404 for the class not found');
    });
    ...
    test('updateClass() - teacher does not exist', async () => {
        ...
        assert.strictEqual(updateClassResponse.statusCode, 404, 'Expected the status code to be 404 for the teacher not found');
    });
    ...
    test('assignStudent() - success', async () => {
        ...
        assert.strictEqual(assignStudentResponse.statusCode, 200, 'Expected the status code to be 200 for the successful student assignment');
    ...
    test('assignStudent() - validation error', async () => {
        ...
        assert.strictEqual(assignStudentResponse.statusCode, 400, 'Expected the status code to be 400 for the validation error');
    ...
    test('assignStudent() - class does not exist', async () => {
        ...
        assert.strictEqual(assignStudentResponse.statusCode, 404, 'Expected the status code to be 404 for the class not found');
    });
    ...
    test('assignStudent() - student does not exist', async () => {
        ...
        assert.strictEqual(assignStudentResponse.statusCode, 404, 'Expected the status code to be 404 for the student not found');
    });
    ...
    test('deleteClass() - success', async () => {
        ...
        assert.strictEqual(deleteClassResponse.statusCode, 200, 'Expected the status code to be 200 for the successful class deletion');
    ...
    test('deleteClass() - validation error', async () => {
        ...
        const deleteClassResponse = await sendDeleteRequest(`/class/${invalidId}`);
        assert.strictEqual(deleteClassResponse.statusCode, 400, 'Expected the status code to be 400 for the validation error');
    ...
    test('deleteClass() - class does not exist', async () => {
        ...
        const deleteClassResponse = await sendDeleteRequest(`/class/${invalidId}`);
        assert.strictEqual(deleteClassResponse.statusCode, 404, 'Expected the status code to be 404 for the class not found');
    });
});